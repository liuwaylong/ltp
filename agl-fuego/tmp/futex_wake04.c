...
{
printf("2 futex_wait futex1 start...\n");
	futex_wait(futex1, *futex1, &to, 0);
printf("2 futex_wait futex1 end...\n");
...
printf("3 futex_wait futex2 start...\n");
//	sleep(2);
...
printf("3 futex_wait futex2 end...\n");
